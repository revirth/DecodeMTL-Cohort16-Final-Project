...
export default class Actualfooter extends Component {
  ...
  margin-top: 5%;}`
        ...
        />
        <footer className="pa4 pa5-l black-70 bt b--black-10 footr">
          <div className="ftrclass">
            <div className="mb4-l cf mgbtm">
              <article className="fl w-50 dib-ns w-auto-ns mr4-m mr5-l mb4 pr2 pr0-ns footercard">
                <h4 className="f5 f3-l fw6">3 Place Ville Marie</h4>
                <span className="f7 f4-l db black-70">4th Floor</span>
                <span className="f7 f4-l black-70">Montreal, QC H3B 2E3 </span>
                <a
                  className="f6 db fw6 pv3 black-70 link dim"
                  title="Call SF"
                  href="tel:+12075555555"
                >
                  Phone number (438) 788-7057
                </a>
              </article>
