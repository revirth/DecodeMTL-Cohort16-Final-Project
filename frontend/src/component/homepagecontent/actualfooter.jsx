...
export default class Actualfooter extends Component {
  ...
  margin-top: 5%;}`
        ...
        />
        <footer class="pa4 pa5-l black-70 bt b--black-10 footr">
          <div className="ftrclass">
            <div class="mb4-l cf mgbtm">
              <article class="fl w-50 dib-ns w-auto-ns mr4-m mr5-l mb4 pr2 pr0-ns footercard">
                <h4 class="f5 f3-l fw6">3 Place Ville Marie</h4>
                <span class="f7 f4-l db black-70">4th Floor</span>
                <span class="f7 f4-l black-70">Montreal, QC H3B 2E3 </span>
                <a
